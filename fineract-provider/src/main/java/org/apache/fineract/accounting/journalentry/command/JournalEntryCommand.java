...
public class JournalEntryCommand {
    ...
    private final Long creditOfficeId;
    ...
    public JournalEntryCommand(final Long officeId, final Long creditOfficeId,  final String currencyCode, final LocalDate transactionDate, final String comments,
        ...
        this.creditOfficeId = creditOfficeId;
    ...
    public void validateForCreate() {
        ...
        baseDataValidator.reset().parameter("creditOfficeId").value(this.creditOfficeId).notNull().integerGreaterThanZero();
    ...
    public Long getCreditOfficeId() {
		return creditOfficeId;
	}
