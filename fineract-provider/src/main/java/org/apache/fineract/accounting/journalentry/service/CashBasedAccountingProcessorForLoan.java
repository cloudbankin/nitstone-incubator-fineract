...
public class CashBasedAccountingProcessorForLoan implements AccountingProcessorForLoan {
             ...
             **/
                ...
                if (principalAmount != null && !(principalAmount.compareTo(BigDecimal.ZERO) == 0)) {
                    this.helper.createCashBasedJournalEntriesAndReversalsForLoan(office, currencyCode,
                            ...
                            loanTransactionDTO.isReversed(), note);
    ...
    private void createJournalEntriesForDisbursements(final LoanDTO loanDTO, final LoanTransactionDTO loanTransactionDTO,
        ...
        if(loanTransactionDTO.isLoanToLoanTransfer()){
            ...
            this.helper.createCashBasedJournalEntriesAndReversalsForLoan(office, currencyCode,
                    ...
                    paymentTypeId, loanId, transactionId, transactionDate, disbursalAmount, isReversal, note);
        	...
        	/*if(!isReversal)
        		this.helper.checkClosingBalanceForCreditAmounts(CASH_ACCOUNTS_FOR_LOAN.FUND_SOURCE.getValue(), office.getId(), transactionDate, office.getHierarchy(), disbursalAmount, loanProductId, paymentTypeId);*/
            this.helper.createCashBasedJournalEntriesAndReversalsForLoan(office, currencyCode,
     ...
     */
    private void createJournalEntriesForRepayments(final LoanDTO loanDTO, final LoanTransactionDTO loanTransactionDTO, final Office office, String note) {
        // loan properties
        final Long loanProductId = loanDTO.getLoanProductId();
        final Long loanId = loanDTO.getLoanId();
        final String currencyCode = loanDTO.getCurrencyCode();
        ...
        if (feesAmount != null && !(feesAmount.compareTo(BigDecimal.ZERO) == 0)) {
            ...
            this.helper.createCreditJournalEntryOrReversalForLoanCharges(office, currencyCode,
                    ...
                    isReversal, loanTransactionDTO.getFeePayments(), note);
        }
        ...
        if (penaltiesAmount != null && !(penaltiesAmount.compareTo(BigDecimal.ZERO) == 0)) {
            ...
            this.helper.createCreditJournalEntryOrReversalForLoanCharges(office, currencyCode,
                    ...
                    penaltiesAmount, isReversal, loanTransactionDTO.getPenaltyPayments(), note);
        }
    ...
    private void createJournalEntriesForRecoveryRepayments(final LoanDTO loanDTO, final LoanTransactionDTO loanTransactionDTO,
        ...
        this.helper.createCashBasedJournalEntriesAndReversalsForLoan(office, currencyCode, CASH_ACCOUNTS_FOR_LOAN.FUND_SOURCE.getValue(),
                ...
                transactionDate, amount, isReversal, note);
    ...
    private void createJournalEntriesForRefundForActiveLoan(LoanDTO loanDTO, LoanTransactionDTO loanTransactionDTO, Office office, String note) {
        ...
        this.helper.createDebitJournalEntryOrReversalForLoan(office, currencyCode, CASH_ACCOUNTS_FOR_LOAN.FUND_SOURCE.getValue(), loanProductId,
                paymentTypeId, loanId, transactionId, transactionDate, totalDebitAmount, !isReversal, note);
