...
public interface GLAccountReadPlatformService {
    ...
    List<GLAccountData> retrieveAllGLAccounts(Integer accountClassification, String searchParam, Integer usage,
            Boolean manualTransactionsAllowed, Boolean disabled, Boolean manualCharge, JournalEntryAssociationParametersData associationParametersData);
    ...
    BigDecimal retrieveClosingBalanceOfGLAccount(final Long acountId);
}