...
public class JournalEntryReadPlatformServiceImpl implements JournalEntryReadPlatformService {
    ...
    public Long retrieveLastTransactionId(Long ofceId) {
    	String sql = "select COUNT(DISTINCT a.transaction_id) from acc_gl_journal_entry a where a.office_id = ?";
    	return this.jdbcTemplate.queryForObject(sql, new Object[] {ofceId}, Long.class);
    }
    ...
    @Override
    public BigDecimal retrieveClosingBalanceForCredit(Long glAccountId, Long officeId, Date transactionDate, String hierarchy) {
    	 final GLJournalEntryClosingBalanceMapper rm = new GLJournalEntryClosingBalanceMapper();
    	 try {
    		final String sql = "select " + rm.schema();

    		return this.jdbcTemplate.queryForObject(sql, rm, new Object[] {hierarchy, transactionDate, officeId, glAccountId });
    ...
    private static final class GLJournalEntryClosingBalanceMapper implements RowMapper<BigDecimal> {
