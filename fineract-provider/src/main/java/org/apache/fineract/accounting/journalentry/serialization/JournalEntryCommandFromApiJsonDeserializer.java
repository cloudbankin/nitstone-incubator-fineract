...
public final class JournalEntryCommandFromApiJsonDeserializer extends AbstractFromApiJsonDeserializer<JournalEntryCommand> {
    ...
    public JournalEntryCommand commandFromApiJson(final String json) {
        ...
        final Long creditOfficeId = this.fromApiJsonHelper.extractLongNamed(JournalEntryJsonInputParams.CREDIT_OFFICE_ID.getValue(), element);
        ...
        return new JournalEntryCommand(officeId, creditOfficeId, currencyCode, transactionDate, comments, credits, debits, referenceNumber,
