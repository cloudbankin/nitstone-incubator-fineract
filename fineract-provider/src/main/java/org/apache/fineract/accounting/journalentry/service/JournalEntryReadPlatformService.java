...
public interface JournalEntryReadPlatformService {
    ...
    Long retrieveLastTransactionId(Long officeId);
    
    BigDecimal retrieveClosingBalanceForCredit(Long glAccountId, Long officeId, Date transactionDate, String hierarchy);
