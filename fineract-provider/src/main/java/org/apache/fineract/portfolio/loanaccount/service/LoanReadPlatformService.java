...
public interface LoanReadPlatformService {
    ...
    Long retrieveLoanAccural(Long loanId);
    ...
    LoanTransactionData retrieveLoanPrePaymentTemplateNew(Long loanId, LocalDate onDate);
    
    LoanTransactionData retrieveLoanPrePaymentTemplateGetAddCharge(Long loanId, LocalDate onDate);
