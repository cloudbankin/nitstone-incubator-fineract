...
public class LoanTransactionEnumData {
    ...
    private final boolean incomePost;
    private final boolean manualCharge;
    private final boolean repaymentAtInstallmentRescheduled;
    ...
    public LoanTransactionEnumData(final Long id, final String code, final String value) {
        ...
        this.repaymentAtInstallmentRescheduled = Long.valueOf(20).equals(this.id);
        this.incomePost = Long.valueOf(19).equals(this.id);
        this.manualCharge = Long.valueOf(22).equals(this.id);
    }
    ...
    public boolean isRepaymentAtInstallmentRescheduled() {
        return this.repaymentAtInstallmentRescheduled;
    }
    ...
    public boolean isIncomePost() {
        return this.incomePost;
    }
