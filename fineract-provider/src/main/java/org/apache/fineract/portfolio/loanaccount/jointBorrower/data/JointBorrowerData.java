...
public class JointBorrowerData {
    ...
    public static JointBorrowerData template(final List<EnumOptionData> guarantorTypeOptions,
            final Collection<CodeValueData> allowedClientRelationshipTypes, Collection<PortfolioAccountData> accountLinkingOptions) {
              final boolean status = false;
        return new JointBorrowerData(null, null, null, null, GuarantorEnumerations.guarantorType(GuarantorType.CUSTOMER), null, null, null,
                null, null, null, null, null, null, null, null, null, null, null, null, status,
                guarantorTypeOptions, allowedClientRelationshipTypes, accountLinkingOptions,null);
    }

    public static JointBorrowerData templateOnTop(final JointBorrowerData guarantorData, final List<EnumOptionData> guarantorTypeOptions,
            final Collection<CodeValueData> allowedClientRelationshipTypes, Collection<PortfolioAccountData> accountLinkingOptions) {
        return new JointBorrowerData(guarantorData.id, guarantorData.loanId, guarantorData.clientRelationshipType, guarantorData.entityId,
    ...
    public static JointBorrowerData mergeClientData(final ClientData clientData, final JointBorrowerData guarantorData) {
        return new JointBorrowerData(guarantorData.id, guarantorData.loanId, guarantorData.clientRelationshipType, guarantorData.entityId,
                ...
                guarantorData.status, null, guarantorData.allowedClientRelationshipTypes,
                guarantorData.accountLinkingOptions,null);
    }

    public static JointBorrowerData mergeStaffData(final StaffData staffData, final JointBorrowerData guarantorData) {
        return new JointBorrowerData(guarantorData.id, guarantorData.loanId, guarantorData.clientRelationshipType, guarantorData.entityId,
                guarantorData.guarantorType, staffData.getFirstname(), staffData.getLastname(), null, null, null, null, null, null, null,
                null, null, null, staffData.getOfficeName(), null, null, guarantorData.status, null,
                guarantorData.allowedClientRelationshipTypes, guarantorData.accountLinkingOptions,null);
    }

    public JointBorrowerData(final Long id, final Long loanId, final CodeValueData clientRelationshipType, final Long entityId,
            ...
            final Collection<CodeValueData> allowedClientRelationshipTypes, final Collection<PortfolioAccountData> accountLinkingOptions, final String clientAccountno) {
        this.id = id;
        this.loanId = loanId;
