...
public class LoanScheduleAssembler {
    ...
    public LoanScheduleModel assembleLoanScheduleFrom(final LoanApplicationTerms loanApplicationTerms, final boolean isHolidayEnabled,
        ...
        String istrue=this.fromApiJsonHelper.extractStringNamed("isFixedAmount", element);
        ...
        return loanScheduleGenerator.generate(mc, loanApplicationTerms, loanCharges, detailDTO, istrue, loanProduct);
    }
