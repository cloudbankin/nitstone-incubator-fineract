...
public class ClientWritePlatformServiceJpaRepositoryImpl implements ClientWritePlatformService {
    ...
    @Autowired
    public ClientWritePlatformServiceJpaRepositoryImpl(final RoutingDataSource dataSource,final PlatformSecurityContext context,
...
//            {
//            	getaccountno(command.getClientId());
//            }
//            
            return new CommandProcessingResultBuilder() //
