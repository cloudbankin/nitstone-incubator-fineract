...
public final class LoanSummary {
    ...
    @Column(name = "manual_charges_charged_derived", scale = 6, precision = 19)
    private BigDecimal totalManualChargesCharged;
    
    @Column(name = "manual_charges_repaid_derived", scale = 6, precision = 19)
    private BigDecimal totalManualChargesRepaid;
    ...
    public void zeroFields() {
        ...
        this.totalManualChargesCharged= BigDecimal.ZERO;
        this.totalManualChargesRepaid = BigDecimal.ZERO;
    }
    ...
    public BigDecimal getTotalManualChargesCharged() {
		return totalManualChargesCharged;
	}

	public void setTotalManualChargesCharged(BigDecimal totalManualChargesCharged) {
		this.totalManualChargesCharged = totalManualChargesCharged;
	}

	public BigDecimal getTotalManualChargesRepaid() {
		return totalManualChargesRepaid;
	}

	public void setTotalManualChargesRepaid(BigDecimal totalManualChargesRepaid) {
		this.totalManualChargesRepaid = totalManualChargesRepaid;
	}
