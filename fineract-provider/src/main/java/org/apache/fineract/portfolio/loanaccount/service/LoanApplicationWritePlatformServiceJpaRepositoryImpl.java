...
public class LoanApplicationWritePlatformServiceJpaRepositoryImpl implements LoanApplicationWritePlatformService {
    ...
    public LoanApplicationWritePlatformServiceJpaRepositoryImpl(final PlatformSecurityContext context, final FromJsonHelper fromJsonHelper,
            ...
            final EntityDatatableChecksWritePlatformService entityDatatableChecksWritePlatformService,final SmsProcessingService smsProcessingService) {
    ...
    public CommandProcessingResult submitApplication(final JsonCommand command) {
        ...
        try {
            ...
            newLoanApplication.setLoanSubType();
    ...
    public CommandProcessingResult approveApplication(final Long loanId, final JsonCommand command) {
        ...
        final BigDecimal approvedAmount = command.bigDecimalValueOfParameterNamed(LoanApiConstants.approvedLoanAmountParameterName);
        ...
        if(CommonMethodsUtil.isNotNull(loan.client()) && CommonMethodsUtil.isNotBlank(loan.client().mobileNo())&&CommonMethodsUtil.isNotBlank(approvedAmount)) {
             ...
             String templateParamString = "templateParameters[A]="+approvedAmount;
//             String templateParamString = "templateParameters[A]="+amountDisbursed.toString()+"&templateParameters[B]="+actualDisbursementDate.toString("dd/MM/yyyy");
        SMSDataVO smsdata = new SMSDataVO("Loansanction", loan.client().mobileNo(), templateParamString);
