...
public enum AccountType {
	...
	JOINTBORROWER(4,"accountType.jointBorrower");
    ...
    public static AccountType fromInt(final Integer accountTypeValue) {
        ...
        switch (accountTypeValue) {
            ...
            case 4:
            	enumeration = AccountType.JOINTBORROWER;
            break;
        }
        return enumeration;
    }
    ...
    public boolean isJointBorrower() {
        return this.value.equals(AccountType.JOINTBORROWER.getValue());
    }
}