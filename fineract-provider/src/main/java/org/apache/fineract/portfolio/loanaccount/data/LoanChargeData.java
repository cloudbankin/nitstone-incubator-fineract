...
public class LoanChargeData {
    ...
    // Habile changes for tax
 	...
 	Collection<FinabileLoanChargeTaxData> taxComponentDatas;

 	public Collection<FinabileLoanChargeTaxData> getTaxComponentDatas() {
 		return taxComponentDatas;
 	}

 	public void setTaxComponentDatas(Collection<FinabileLoanChargeTaxData> taxComponentDatas) {
 		this.taxComponentDatas = taxComponentDatas;
 	}
    ...
    public static LoanChargeData template(final Collection<ChargeData> chargeOptions) {
        return new LoanChargeData(null, null, null, null, null, null, null, null, chargeOptions, false, null, false,
    ...
    public LoanChargeData(LoanChargeData chargeData, Collection<LoanInstallmentChargeData> installmentChargeData) {
        ...
        this.feesComponent = chargeData.feesComponent;
		this.taxComponent = chargeData.taxComponent;
    }
