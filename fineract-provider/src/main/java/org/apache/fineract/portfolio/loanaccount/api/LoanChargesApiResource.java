...
public class LoanChargesApiResource {
    ...
    public String retrieveLoanCharge(@PathParam("loanId") final Long loanId, @PathParam("chargeId") final Long loanChargeId,
		...
		final Collection<FinabileLoanChargeTaxData> taxComponentDatas = this.loanChargeReadPlatformService
				.retrieveLoanChargeTaxComponents(loanChargeId);
		loanChargeData.setTaxComponentDatas(taxComponentDatas);
		/** Habile changes end */
    ...
    @Consumes({ MediaType.APPLICATION_JSON })
    @Produces({ MediaType.APPLICATION_JSON })
    public String addManualCharge(@PathParam("loanId") final Long loanId, @QueryParam("command") final String commandParam,
            final String apiRequestBodyAsJson) {
       ...
       /* if (is(commandParam, "pay")) {
        ...
        //else {
            final CommandWrapper commandRequest = new CommandWrapperBuilder().addManualCharge(loanId).withJson(apiRequestBodyAsJson)
                    .build();
            result = this.commandsSourceWritePlatformService.logCommandSource(commandRequest);
        //}
    ...
    @Consumes({ MediaType.APPLICATION_JSON })
    @Produces({ MediaType.APPLICATION_JSON })
    public String payManualCharge(@PathParam("loanId") final Long loanId, @QueryParam("command") final String commandParam,
            final String apiRequestBodyAsJson) {
       ...
       /* if (is(commandParam, "pay")) {
        ...
        //else {
            final CommandWrapper commandRequest = new CommandWrapperBuilder().payManualCharge(loanId).withJson(apiRequestBodyAsJson)
                    .build();
            result = this.commandsSourceWritePlatformService.logCommandSource(commandRequest);
        //}
