...
public enum ChargeTimeType {
    ...
    INSTALLMENT_RESCHEDULED(18, "chargeTimeType.installmentRescheduled"),
    SAVINGS_NOACTIVITY_FEE(16,"chargeTimeType.savingsNoActivityFee"),
	PREPAYMENT(17,"chargeTimeType.prePayment");
    ...
    public static Object[] validLoanValues() {
        return new Integer[] { ChargeTimeType.DISBURSEMENT.getValue(), ChargeTimeType.SPECIFIED_DUE_DATE.getValue(),
                ...
                ChargeTimeType.TRANCHE_DISBURSEMENT.getValue(),ChargeTimeType.PREPAYMENT.getValue() };
    }
    ...
    public boolean isTimeOfPrepayment() {
        return ChargeTimeType.PREPAYMENT.getValue().equals(this.value);
    }
    ...
    public boolean isAllowedLoanChargeTime() {
        return isTimeOfDisbursement() || isOnSpecifiedDueDate() || isInstalmentFee() || isOverdueInstallment() || isTrancheDisbursement()||isTimeOfPrepayment();
    }
    ...
    public boolean isInstallmentRescheduled() {
        return this.value.equals(ChargeTimeType.INSTALLMENT_RESCHEDULED.getValue());
    }
}