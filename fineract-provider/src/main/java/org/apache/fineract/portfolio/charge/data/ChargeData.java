...
public class ChargeData implements Comparable<ChargeData>, Serializable {
    ...
    /*
     * Habile changes initializing two new variables for charges mappin
     */
    Collection<ChargeData> availableCharges;
    Collection<ChargeData> selectedCharges;
    public ChargeAdditionalDetails chargeAdditionalDetails;
	...
	public Collection<ChargeData> getAvailableCharges() {
		return availableCharges;
	}

	public void setAvailableCharges(Collection<ChargeData> availableCharges) {
		this.availableCharges = availableCharges;
	}

	public Collection<ChargeData> getSelectedCharges() {
		return selectedCharges;
	}

	public void setSelectedCharges(Collection<ChargeData> selectedCharges) {
     ...
     */
    public boolean isExtensionFeeCharge() {
        boolean isExtensionFeeCharge = false;
        if (this.chargeTimeType != null) {
        	isExtensionFeeCharge = ChargeTimeType.fromInt(this.chargeTimeType.getId().intValue()).isInstallmentRescheduled();
        }
        return isExtensionFeeCharge;
    }
    /*
     * Habile changes end
     */
