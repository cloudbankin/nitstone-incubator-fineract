 ...
 * under the License.
 */
package org.apache.fineract.portfolio.loanaccount.jointBorrower.command;
 ...
 */
public class JointBorrowerCommand {
    ...
    public JointBorrowerCommand(final Long clientRelationshipTypeId, final Integer guarantorTypeId, final Long entityId,
