        ...
        switch (type) {
            ...
            case REPAYMENT_AT_DISBURSEMENT:
                optionData = new LoanTransactionEnumData(LoanTransactionType.REPAYMENT_AT_DISBURSEMENT.getValue().longValue(),
                        LoanTransactionType.REPAYMENT_AT_DISBURSEMENT.getCode(), "Processing Fee Collected");
            break;
            case CONTRA:
            ...
            case INCOME_POSTING:
                optionData = new LoanTransactionEnumData(LoanTransactionType.INCOME_POSTING.getValue().longValue(),
                        LoanTransactionType.INCOME_POSTING.getCode(), "Interest Debit");
            break;
            case FEE_POSTING:
                optionData = new LoanTransactionEnumData(LoanTransactionType.INCOME_POSTING.getValue().longValue(),
                        LoanTransactionType.INCOME_POSTING.getCode(), "Fee Debit");
            break;
            case PENALITY_POSTING:
                optionData = new LoanTransactionEnumData(LoanTransactionType.INCOME_POSTING.getValue().longValue(),
                        LoanTransactionType.INCOME_POSTING.getCode(), "Penality Debit");
            break;
            case MANUAL_CHARGE:
                optionData = new LoanTransactionEnumData(LoanTransactionType.MANUAL_CHARGE.getValue().longValue(),
                        LoanTransactionType.MANUAL_CHARGE.getCode(), "Other Charges Charged");
            break;
            case PAY_MANUAL_CHARGE:
                optionData = new LoanTransactionEnumData(LoanTransactionType.PAY_MANUAL_CHARGE.getValue().longValue(),
                        LoanTransactionType.PAY_MANUAL_CHARGE.getCode(), "Other Charges Paid");
            break;
            default:
            break;
        }
