...
public class LoanProduct extends AbstractPersistableCustom<Long> {
    ...
    @Column(name = "is_new_product_config", nullable = true)
    private boolean isNewProductConfig = true;
 ...
 // Habile Arivu new config
	public boolean isNewProductConfig() {
		return isNewProductConfig;
	}

	public void setNewProductConfig(boolean isNewProductConfig) {
		this.isNewProductConfig = isNewProductConfig;
	}
