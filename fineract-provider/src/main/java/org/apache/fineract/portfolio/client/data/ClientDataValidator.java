...
public final class ClientDataValidator {
    ...
    public void validateForCreate(final String json) {
        ...
        if (this.fromApiJsonHelper.parameterExists(ClientApiConstants.emailParamName, element)) {
            final String email = this.fromApiJsonHelper.extractStringNamed(ClientApiConstants.emailParamName, element);
            baseDataValidator.reset().parameter(ClientApiConstants.emailParamName).value(email).ignoreIfNull()
                    .notExceedingLengthOf(100);
        }
    ...
    public void validateForUpdate(final String json) {
        ...
        if (this.fromApiJsonHelper.parameterExists(ClientApiConstants.emailParamName, element)) {
            atLeastOneParameterPassedForUpdate = true;
            final String email = this.fromApiJsonHelper.extractStringNamed(ClientApiConstants.emailParamName, element);
            baseDataValidator.reset().parameter(ClientApiConstants.emailParamName).value(email).notExceedingLengthOf(100);
        }
