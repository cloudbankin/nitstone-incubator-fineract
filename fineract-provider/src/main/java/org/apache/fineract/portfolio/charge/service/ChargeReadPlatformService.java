...
public interface ChargeReadPlatformService {
   ...
   /* List<ChargeSlabDetails> retriveSlabDetails(Long chargeId);*/
    /*
     * Habile changes
     * define method to retrieve only extension charges
     */
    Collection<ChargeData> retrieveLoanApplicableExtensionFeeCharges();
    ChargeAdditionalDetails getChargeAdditionalDetails(Long chargeId);
    /*
     * Habile changes end
     */
}
