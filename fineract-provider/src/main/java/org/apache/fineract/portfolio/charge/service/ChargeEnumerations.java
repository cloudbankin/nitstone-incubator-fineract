...
public class ChargeEnumerations {
    ...
    public static EnumOptionData chargeTimeType(final ChargeTimeType type) {
        ...
        switch (type) {
            ...
            break;
            case PREPAYMENT:
            	optionData = new EnumOptionData(ChargeTimeType.PREPAYMENT.getValue().longValue(), ChargeTimeType.PREPAYMENT.getCode(), 
            			"PrePayment");
            break;
            default:
    ...
    public static EnumOptionData chargeCalculationType(final ChargeCalculationType type) {
        ...
        switch (type) {
            ...
            case PERCENT_OF_OUTSTANDING:
            	optionData = new EnumOptionData(ChargeCalculationType.PERCENT_OF_OUTSTANDING.getValue().longValue(),
            	        ChargeCalculationType.PERCENT_OF_OUTSTANDING.getCode(), "% Outsanding Amount");
            break;
            default:
