...
public class LoanScheduleParams {
    ...
    private LoanScheduleParams(final int periodNumber, final int instalmentNumber, int loanTermInDays, LocalDate periodStartDate,
            ...
            final boolean partialUpdate, final MonetaryCurrency currency, final boolean applyInterestRecalculation,final LocalDate compoundingDate) {
        ...
        this.compoundingDate = compoundingDate;
    }
    ...
    public LocalDate getCompondingDate() {
        return this.compoundingDate;
    }
    ...
    public void setCompondingDate(LocalDate date) {
        this.compoundingDate = date;
    }
