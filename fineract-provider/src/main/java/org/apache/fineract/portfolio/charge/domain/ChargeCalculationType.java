...
public enum ChargeCalculationType {
	...
	PERCENT_OF_OUTSTANDING(6, "chargeCalculationType.percent.of.outstanding.amount"),
	PERCENT_OF_OUTSTANDING_LOAN_AMOUNT(7,"chargeCalculationType.percent.of.outstanding.loan.amount");
    ...
    public static Object[] validValuesForLoan() {
        return new Integer[] { ChargeCalculationType.FLAT.getValue(), ChargeCalculationType.PERCENT_OF_AMOUNT.getValue(),
                ...
                ChargeCalculationType.PERCENT_OF_DISBURSEMENT_AMOUNT.getValue(),ChargeCalculationType.PERCENT_OF_OUTSTANDING.getValue()};
    }
    ...
    public static ChargeCalculationType fromInt(final Integer chargeCalculation) {
        ...
        switch (chargeCalculation) {
            ...
            break;
            case 6:
            	chargeCalculationType = PERCENT_OF_OUTSTANDING;
            break;
        }
    ...
    public boolean isPercentageOfOustStanding() {
        return this.value.equals(ChargeCalculationType.PERCENT_OF_OUTSTANDING.getValue());
    }
    ...
    public boolean ispercentageOfOutstandingLoanAmount() {
    	return this.value.equals(ChargeCalculationType.PERCENT_OF_OUTSTANDING_LOAN_AMOUNT.getValue());
    }

    public boolean isPercentageBased() {
        return isPercentageOfAmount() || isPercentageOfAmountAndInterest() || isPercentageOfInterest() || isPercentageOfDisbursementAmount() ||isPercentageOfOustStanding() ;
    }
