...
public class UpdateJointBorrowerCommandHandler implements NewCommandSourceHandler {

    private final GuarantorWritePlatformService writePlatformService;

    @Autowired
    public UpdateJointBorrowerCommandHandler(final GuarantorWritePlatformService writePlatformService) {
