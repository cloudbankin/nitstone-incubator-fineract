...
public class LoanTransactionData {
    ...
    public void setOutstanding(BigDecimal amount) {
    	this.outstandingLoanBalance=amount;
    }
    ...
    public BigDecimal getManualChargesPortion() {
		return manualChargesPortion;
	}

	public void setManualChargesPortion(BigDecimal manualChargesPortion) {
		this.manualChargesPortion = manualChargesPortion;
	}
