 ...
 * under the License.
 */
package org.apache.fineract.portfolio.loanaccount.jointBorrower.serialization;
 ...
 */
@Component
public final class JointBorrowerCommandFromApiJsonDeserializer extends AbstractFromApiJsonDeserializer<JointBorrowerCommand> {

    private final FromJsonHelper fromApiJsonHelper;

    @Autowired
    public JointBorrowerCommandFromApiJsonDeserializer(final FromJsonHelper fromApiJsonHelper) {
        this.fromApiJsonHelper = fromApiJsonHelper;
    }

    @Override
    public JointBorrowerCommand commandFromApiJson(final String json) {
    ...
    private JointBorrowerCommand extractGuarantorCommand(final JsonElement element, final Locale locale, final String dateFormat) {
        ...
        return new JointBorrowerCommand(clientRelationshipTypeId, guarantorTypeId, entityId, firstname, lastname, addressLine1, addressLine2,
