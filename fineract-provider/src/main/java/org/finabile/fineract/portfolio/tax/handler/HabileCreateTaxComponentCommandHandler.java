...
@Service
@Primary
@CommandType(entity = "HABILETAXCOMPONENT", action = "CREATE")
public class HabileCreateTaxComponentCommandHandler implements NewCommandSourceHandler {

	private final HabileTaxWritePlatformService taxWritePlatformService;

	@Autowired
	public HabileCreateTaxComponentCommandHandler(final HabileTaxWritePlatformService taxWritePlatformService) {
